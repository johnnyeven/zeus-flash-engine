...
package Apollo.Controller
{
	...
	public class COtherPlayerController extends CBaseController implements IControllerMovable
	{
		...
		public function COtherPlayerController(per: CPerception)
		{
			super(per);
		...
		override public function set controlObject(o:CGameObject): void
		{
			...
			_skillController = new CSkillNPC(_controlObject as CActionObject);
		}
		
		public function moveTo(x: Number, y: Number): void
		{
			var currentObject: COtherPlayerCharacter = _controlObject as COtherPlayerCharacter;
		...
		{
			var controlObject: COtherPlayerCharacter = _controlObject as COtherPlayerCharacter;
		...
		protected function move(nextX: Number, nextY: Number, controlObject: COtherPlayerCharacter): void
		{
