package view.email
{
	 ...
	 *
	 */
    public class EmailShowBagComponent extends Window
    {
        ...
        public function EmailShowBagComponent()
        {
...
//			{
//				if(value[i].item_type!=ItemEnum.recipes)
//				{
//					newArr.push(value[i]);
//				}
//			}
			for (var i:int = 0; i < value.length; i++)
			{
				...
				if (value[i] != null && value[i].item_type!=ItemEnum.recipes)
				{
