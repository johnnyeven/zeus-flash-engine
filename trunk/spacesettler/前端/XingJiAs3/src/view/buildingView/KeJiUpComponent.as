...
//			keYanButton.addEventListener(MouseEvent.CLICK,keYanButton_clickHandler);
        ...
        public function set buildType(value:int):void
        {
			...
			var scienceProxy:ScienceResearchProxy=ApplicationFacade.getProxy(ScienceResearchProxy);
			var totalLevel:int=scienceProxy.totalLevel;
			...
			if(nextViewInfoVO.anWuZhiXH>userInfoVO.broken_crysta || nextViewInfoVO.shuiJinXH>userInfoVO.crystal ||
				...
				nextViewInfoVO.all_subjects_level>totalLevel)// || nextViewInfoVO.DianNengXH>userInfoVO.current_power_supply
			{
