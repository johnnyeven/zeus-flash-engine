package view.friendList
{
	...
	public class ResearchXiaComponent extends Component
	{
		...
		public function ResearchXiaComponent()
		{
			super(ClassUtil.getObject("researchXiaComponentSkin"));
		...
		{
			_data = value;
			_data.componentInforType = "researchXiaComponentSkin";
