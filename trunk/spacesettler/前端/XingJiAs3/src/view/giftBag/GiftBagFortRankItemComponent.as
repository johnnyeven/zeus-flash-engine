package view.giftBag
{
	...
	public class GiftBagFortRankItemComponent extends Component
	{
		...
		public function GiftBagFortRankItemComponent()
		{
			super(ClassUtil.getObject("view.giftItem6"));
		...
		public function set setValue(data:GiftBagVO):void
		{
			...
			rankLabel.text="占领要塞排名"+data.rank+"";
