package controller.email
{
     ...
     *
     */
    public class ShowSendEmailComponentMediatorCommand extends SimpleCommand
    {
		private static var _isLoading:Boolean=false;
		
		public static var loadCompleteCallBack:Function;
		
        public function ShowSendEmailComponentMediatorCommand()
        {
            super();
        }
        ...
        {
            var med:SendEmailComponentMediator = new SendEmailComponentMediator();
