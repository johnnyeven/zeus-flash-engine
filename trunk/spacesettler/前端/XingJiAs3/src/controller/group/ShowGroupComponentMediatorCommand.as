package controller.group
{
     ...
     *
     */
    public class ShowGroupComponentMediatorCommand extends SimpleCommand
    {
		private static var _isLoading:Boolean=false;
		
		public static var loadCompleteCallBack:Function;
		
        public function ShowGroupComponentMediatorCommand()
        {
            super();
        }
        ...
        public override function execute(notification:INotification):void
        {
            ...
            var med:GroupComponentMediator = getMediator(GroupComponentMediator);
            if (med)
            {
				callShow(med);
            }
        ...
        {
            var med:GroupComponentMediator = new GroupComponentMediator();
