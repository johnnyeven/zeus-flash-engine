package controller.ranking
{
     ...
     *
     */
    public class ShowRankingComponentMediatorCommand extends SimpleCommand
    {
		private static var _isLoading:Boolean=false;
		
		public static var loadCompleteCallBack:Function;
		
        public function ShowRankingComponentMediatorCommand()
        {
            super();
        }
        ...
        public override function execute(notification:INotification):void
        {
            ...
            var med:RankingComponentMediator = getMediator(RankingComponentMediator);
            if (med)
            {
				callShow(med);
            }
        ...
        {
            var med:RankingComponentMediator = new RankingComponentMediator();
