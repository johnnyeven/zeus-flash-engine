package mediator.buildingView
{
	 ...
	 * 
	 */
	public class DianChangCreateComponentMediator extends BaseMediator implements IMediator
	{
		public static const NAME:String="DianChangCreateComponentMediator";
		
		public static const SHOW_NOTE:String="show" + NAME + "Note";
		
		public static const DESTROY_NOTE:String="destroy" + NAME + "Note";
		
		public function DianChangCreateComponentMediator()
		{
			super(NAME,new CreateViewComponent(ClassUtil.getObject(formatStr("build_annengdianchang_view_{0}"))));
			comp.med=this;
			level=1;
		...
		protected function buildHandler(event:Event):void
		{
			...
			buildProxy.buildBuild(BuildTypeEnum.DIANCHANG, function():void
			{
				comp.buildType = BuildTypeEnum.DIANCHANG;
			});
		}
