package mediator.buildingView
{
	 ...
	 * 
	 */
	public class DianChangInfoComponentMediator extends BaseMediator implements IMediator
	{
		public static const NAME:String="DianChangInfoComponentMediator";
		...
		{
			super(NAME, new InfoViewComponent(ClassUtil.getObject(formatStr("info_annengdianchang_view_{0}"))));
			comp.med=this;
			level=2;
