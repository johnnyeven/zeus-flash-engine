package mediator.buildingView
{
     ...
     *
     */
    public class YeLianCreateComponentMediator extends BaseMediator implements IMediator
    {
        public static const NAME:String = "YeLianCreateComponentMediator";
        ...
        protected function buildHandler(event:Event):void
        {
            ...
            buildProxy.buildBuild(BuildTypeEnum.KUANGCHANG, function():void
            {
                comp.buildType = BuildTypeEnum.KUANGCHANG;
            });
        }
