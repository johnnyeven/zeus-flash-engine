	...
	*/
	public class CenterUpComponent extends Component
	{
		...
		public function CenterUpComponent(skin:DisplayObjectContainer)
		{
			...
			shiDai1MC=createUI(MovieClip,"shiDai1_MC");
			shiDai2MC=createUI(MovieClip,"shiDai2_MC");
			shiDai3MC=createUI(MovieClip,"shiDai3_MC");
			shiDai4MC=createUI(MovieClip,"shiDai4_MC");
