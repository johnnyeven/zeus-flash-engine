package view.buildingView
{
	...
	public class ConditionViewComp extends Component
	{
		...
		private var centerUpComponent:CenterUpComponent;
		
		public function ConditionViewComp(skin:DisplayObjectContainer)
		{
			super(skin);
