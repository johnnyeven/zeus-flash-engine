package mediator.buildingView
{
	 ...
	 * 
	 */
	public class ChuanQinCreateComponentMediator extends BaseMediator implements IMediator
	{
		public static const NAME:String="ChuanQinCreateComponentMediator";
		
		public static const SHOW_NOTE:String="show" + NAME + "Note";
		
		public static const DESTROY_NOTE:String="destroy" + NAME + "Note";
		
		public var chuanQinCreateViewComp:CreateViewComponent;
		...
		protected function buildHandler(event:Event):void
		{
			...
			buildProxy.buildBuild(BuildTypeEnum.CHUANQIN, function():void
			{
				comp.buildType = BuildTypeEnum.CHUANQIN;
			});
		}
