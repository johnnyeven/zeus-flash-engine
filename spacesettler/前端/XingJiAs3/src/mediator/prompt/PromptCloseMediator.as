package mediator.prompt
{
	...
	public class PromptCloseMediator extends BaseMediator implements IMediator
	{		
		public static const NAME:String = "PromptCloseMediator";
		...
		public function PromptCloseMediator()
		{
			super(NAME, new PromptSureComponent(ClassUtil.getObject("res.Prompt_1_InfoSkin")));
