package controller.allView
{
     ...
     *
     */
    public class ShowAllViewComponentMediatorCommand extends SimpleCommand
    {
		private static var _isLoading:Boolean=false;
		
		public static var loadCompleteCallBack:Function;
		
        public function ShowAllViewComponentMediatorCommand()
        {
            super();
        }
        ...
        {
            var med:AllViewComponentMediator = new AllViewComponentMediator();
