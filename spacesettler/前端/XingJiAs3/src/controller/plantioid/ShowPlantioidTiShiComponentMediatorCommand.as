package controller.plantioid
{
     ...
     *
     */
    public class ShowPlantioidTiShiComponentMediatorCommand extends SimpleCommand
    {
        ...
        public function ShowPlantioidTiShiComponentMediatorCommand()
        {
            super();
        }
        ...
        public override function execute(notification:INotification):void
        {
            ...
            var med:PlantioidTiShiComponentMediator = getMediator(PlantioidTiShiComponentMediator);
            if (med)
            {
				callShow(med);
            }
        ...
        {
            var med:PlantioidTiShiComponentMediator = new PlantioidTiShiComponentMediator();
