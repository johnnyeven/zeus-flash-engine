package controller.buildingView
{
    ...
    public class ShowCangKuCreateComponentMediatorCommand extends SimpleCommand
    {
        ...
        public override function execute(notification:INotification):void
        {
            ...
            var med:CangKuCreateComponentMediator = getMediator(CangKuCreateComponentMediator);
            if (med)
            {
                med.show();
            }
        ...
        {
            var med:CangKuCreateComponentMediator = new CangKuCreateComponentMediator();
